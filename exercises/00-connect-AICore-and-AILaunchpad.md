...
👉 Open the SAP BTP subaccount: [GenAI CodeJam]([https://url.sap/xm70jg](https://emea.cockpit.btp.cloud.sap/cockpit#/globalaccount/275320f9-4c26-4622-8728-b6f5196075f5/subaccount/a5a420d8-58c6-4820-ab11-90c7145da589/subaccountoverview))
...
👉 Open **SAP AI Launchpad**. Make sure you authenticate using the **IAS Identity Provider (a7rg4vxjp)**.

![Authentication client](images/auth_ais.png)

👉 If you get an authentication challenge use the credentials provided to you to log in.
...
👉 Select the workspace `codejam-aicore-connection` and the resource group `codejam-genai`.

👉 Make sure it is set as a context. The proper name of the context, `codejam-genai` should show up at the top next to SAP AI Launchpad.

☝️ You will need the name of the resource group in [Exercise 04-create-embeddings](04-create-embeddings.ipynb).
